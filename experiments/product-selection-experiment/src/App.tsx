...
function App() {
  ...
  const [descriptionType, setDescriptionType] = useState<'textWithLinks' | 'textWithLinksDisclosure' | 'chatDisclosure' | 'chatConfirmation' | null>(null);
  ...
  const handleWelcomeSuccess = (params: { userId: string; descriptionType: string; }) => {
    ...
    setDescriptionType(params.descriptionType as 'textWithLinks' | 'textWithLinksDisclosure' | 'chatDisclosure' | 'chatConfirmation');
